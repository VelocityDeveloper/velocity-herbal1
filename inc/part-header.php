<nav id="main-navi" class="navbar navbar-expand-md d-block navbar-light pb-0 px-0 pt-0" aria-labelledby="main-nav-label">
    ...
    <div class="velocity-nav bg-theme shadow px-2 rounded-bottom position-relative">
    ...
    <div class="menu-header d-md-none position-relative bg-theme rounded-bottom" data-bs-theme="dark">
